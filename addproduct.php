...
<body>
    ...
    <div class="managementContainer">
        ...
        <p class="tittle">Product Management System - Add New Product</p>

            <form  class="addContainer" action="additem.php" method="post">
                ...
                <textarea rows = "20" id="overview" name = "overview"></textarea><br>
                <label for="model_no">Model:</label><br>
                <input type="text" id="model_no" name="model_no" required><br>
